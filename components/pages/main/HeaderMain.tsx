            ...
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                ...
                <div className={classNames(open ? "" : "hidden", "w-full md:block md:w-auto")}>
                    <Link href={"/auth/register"}
                          className="md:ml-0 ml-4 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg md:text-lg px-5 py-2.5 mr-2 mb-2 bg-blue-600 hover:bg-blue-700 focus:outline-none">Войти
                    </Link>
                    <Link href={"/buy"}
                          className="md:ml-0 ml-4 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg md:text-lg px-5 py-2.5 mr-2 mb-2 bg-blue-600 hover:bg-blue-700 focus:outline-none">Пополнить баланс
                    </Link>
                </div>
            </div>
        </nav>
