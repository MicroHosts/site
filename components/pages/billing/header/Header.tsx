        ...
        <div className="md:w-64 w-full">
            <div className="overflow-y-auto py-4 px-3">
                <ul className="space-y-2">
                    ...
                    <li>
                        <div
                            className="flex items-center p-2 text-base font-normal rounded-lg text-whit">
                            <FaWallet className="flex-shrink-0 w-6 h-6 transition duration-75 text-gray-400"/>
