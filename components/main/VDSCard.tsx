        ...
        <div className="mt-4 bg-zinc-800 mx-auto rounded">
            <div className="py-4 md:px-24 px-6 flex justify-between md:text-xl text-sm">
                ...
                <div className="my-auto">
                    <button type="button"
                            className="focus:ring-4 focus:ring-blue-300 font-medium rounded-lg md:text-xl text-sm px-5 py-2.5 mr-2 mb-2 bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-blue-800">Заказать
                    </button>
                </div>
            </div>
        </div>
